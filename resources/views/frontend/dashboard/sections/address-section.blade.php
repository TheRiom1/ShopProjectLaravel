<div class="tab-pane fade" id="v-pills-address" role="tabpanel" aria-labelledby="v-pills-address-tab">
    <div class="fp_dashboard_body address_body">
        <h3>Adres <a class="dash_add_new_address"><i class="far fa-plus"></i> Dodaj nowy
            </a>
        </h3>
            ...
            <div class="fp_dashboard_new_address ">
                <form action="{{ route('address.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <button type="button" class="common_btn cancel_new_address">Wyjdź</button>
                            <button type="submit" class="common_btn">Zapisz
                                adres</button>
                        </div>
                    </div>
                </form>
